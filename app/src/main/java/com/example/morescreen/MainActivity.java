    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch(position){
                    case 0:
                        Intent intent1 = new Intent(MainActivity.this, Ar.class);
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent intent3 = new Intent(MainActivity.this, Cl.class);
                        startActivity(intent3);
                        break;
                    case 3:
                        Intent intent4 = new Intent(MainActivity.this, Co.class);
                        startActivity(intent4);
                        break;

                    case 4:
                        Intent intent5 = new Intent(MainActivity.this, Uy.class);
